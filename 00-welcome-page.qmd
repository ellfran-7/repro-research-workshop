...
To ensure everything runs smoothly on the day of the workshop, we’ll need to set up a few things beforehand. Visit the [Pre-workshop instructions](https://ellfran-7.github.io/repro-research-workshop/01-pre-work.html) to set everything up for the day! 🧙