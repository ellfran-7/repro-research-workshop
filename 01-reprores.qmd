...
## What should be kept the same when reproducing a study? :thinking: {style="text-align: center;"}
...
-   **Direct reproducibility** (commonly '*replication*' or '*experimental reproducibility*')
:::

::: {style="color: #588157;" auto-animate-delay="0.2"}
-   **Analytical reproducibility** (commonly '*computational reproducibility*')
:::

::: {style="opacity: .5;" auto-animate-delay="0.2"}
-   **Systemic reproducibility** (commonly '*robustness*')
:::

::: {style="opacity: .5;" auto-animate-delay="0.2"}
-   **Conceptual reproducibility** (commonly '*generalisation*')
:::
...
![The Turing Way project illustration by Scriberia. Used under a CC-BY 4.0 licence. DOI: [10.5281/zenodo.3332807](https://doi.org/10.5281/zenodo.3332807)](images/turingway-definition.svg){.lightbox fig-align="center"}
...
::: {layout="[6,-2,6]"}
![](images/phdcomic-finaldoc.png){.lightbox fig-align="center"}

![](images/jlowndes-ahorst-tidydata.jpg){fig-align="center"}
:::
...
::: {layout="[10,-4,10,-4,10]" layout-valign="center"}
...
![Artwork by Allison Horst](images/ahorst-rabbit-mouse-comp.jpg){fig-align="center" width="100%".a bsolute bottom=10 right=10}}
...
![Illustration by Alison Hill and Allison Horst, for RStudio](images/ahill-ahorst-hedgehog-outputs.png){fig-align="center" width="30%"}
...
::: incremental
1.  For [**communicating**]{.nicegreen} to decision-makers or to a more general audience, who want to focus on the conclusions, not the code behind the analysis
2.  For [**collaborating**]{.nicegreen} with other data scientists (including [**future you!**]{.nicegreen}), who are interested in both your conclusions, and how you reached them (i.e. the code)
3.  As an environment in which to [*do*]{.nicegreen} data science, as a modern-day lab notebook where you can capture not only what you did, but also what you were thinking
:::
