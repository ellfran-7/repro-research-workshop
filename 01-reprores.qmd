...
::: fragment
![My attempt](images/cat-ellis-drawing.jpg){width="90%"}
:::

::: fragment
![The result in the study](images/cat-good-drawing.png){width="90%"}
:::
:::::
...
::: {.column width="40%"}
![Knuth, Donald Ervin. “Literate Programming.” Computer/law journal (1984).](images/dknuth-lp.jpg){width="45%"}
:::
...
![Illustration by Alison Hill and Allison Horst, for RStudio](images/ahill-ahorst-hedgehog-text-code.png){fig-align="center" width="30%"}
