...
<!-- 1.  Reproducible Research: What Do We Know? -->
<!-- 2.  Literate Programming with Quarto: A Small but Impactful Step -->

<!-- Part 1 will be discussion-based, focusing on the concept of reproducibility, its importance, and the factors contributing to non-reproducibility. There will be practial work also. No prior coding or bioinformatics knowledge is needed. -->
